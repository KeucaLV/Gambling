...
class ContentRenderer {
        ...
        const contentMap = {
            ...
            'international': {
                header: {
                    logoSrc: "img/logos.png",
                    navItems: [
                        { href: "index.html", iconClass: "fas fa-dice", text: "Casino" },
                        { href: "betting.html", iconClass: "fas fa-futbol", text: "Betting" },
                        { href: "livecasino.html", iconClass: "fas fa-tv", text: "Live Casino" },
                        { href: "tos.html", iconClass: "fas fa-file-alt", text: "TOS" },
                        { href: "privacy.html", iconClass: "fas fa-user-secret", text: "Privacy Policy" }
                    ],
                    socialLinks: [
                        { href: "https://www.youtube.com", iconSrc: "https://cdn.simpleicons.org/youtube/ffffff", alt: "YouTube" },
                        { href: "https://www.instagram.com", iconSrc: "https://cdn.simpleicons.org/instagram/ffffff", alt: "Instagram" },
    ...
    renderHeader(headerDiv, headerContent) {
        ...
        const countryFlagsHtml = headerContent.countryFlags.map(flag => `
                <li>
                    <a href="./Countrys/${flag.code}" class="dropdown-item">
...
class TOSRenderer extends ContentRenderer {
    ...
    loadContent() {
        const tosContentDiv = document.getElementById('tos');
        const headerDiv = document.getElementById('header');
        const footerDiv = document.getElementById('footer');
        ...
        const contentMap = {
            'ca': {
                ...
                tosTitle: "Terms of Service - ca",
                sections: [
                    { title: "1. Introduction", text: "Welcome to Casino Gambling G ca. By accessing our website, you agree to these terms and conditions." },
                    { title: "2. Use of Site", text: "Our site is provided for your personal use subject to these terms and conditions." },
                    { title: "3. Intellectual Property", text: "All content included on this site is the property of Casino Gambling G ca or its content suppliers." },
                ...
                footer: {
                    aboutUs: "About Us content for ca.",
                    subscribe: "Subscribe content for ca.",
                    footerLinks: [
                        { text: "YouTube", href: "https://www.youtube.com/channel/UCjq4CUr2qYYsGxmw5gbq4RA" },
                        { text: "Instagram", href: "#" },
                        { text: "X/Twitter", href: "https://x.com/crazygamblingg" },
    ...
    loadContent() {
        ...
        const contentMap = {
            'ca': {
                ...
                privacyTitle: "Privacy Policy - ca",
                sections: [
